...
public class TestUtils {
  public static void assertOnlyTablesExists(Connection connection, String...tables) throws SQLException {
    List<String> tableList = ConnectionUtils.tables(connection);
    assertThat(tableList).containsOnly(tables);
  }

  public static void assertOnlyColumnsExists(Connection connection, String table, String...columns) throws SQLException {
